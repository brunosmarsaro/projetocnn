...
output_labels = "trained_labels.txt"
final_tensor_name = "softmax"

# Carregar base de dados
import input
inputs = input.Process(path=database_path)
images, image_lists = inputs.run(testing_percentage, validation_percentage)
...
print("TESTING: %d "%(testing_percentage))
...
h_pool1 = max_pool_2x2(h_conv1) # 32x32
...
h_pool2 = max_pool_2x2(h_conv2) # 16x16
...
W_conv5 = weight_variable([6, 6, 64, 256]) #2,2,64,256
b_conv5 = bias_variable([256])

h_conv5 = tf.nn.relu(conv2d(h_pool4, W_conv5) + b_conv5)
h_pool5 = max_pool_2x2(h_conv5) # 4x4
