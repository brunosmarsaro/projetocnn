...
W_conv1 = weight_variable([20, 20, 1, 48])
...
W_conv2_1c1 = weight_variable([10, 10, 48, 64])
...
W_conv2_2c1 = weight_variable([7, 7, 48, 128])
...
W_conv2_3c1 = weight_variable([8, 8, 48, 64])  # 2,2,64,256
...
h_conv3_avg = tflearn.layers.merge_ops.merge([h_conv2_1c1, h_conv2_2c2, h_conv2_3c1],
												mode="elemwise_sum") 
#print(h_conv3_avg)
